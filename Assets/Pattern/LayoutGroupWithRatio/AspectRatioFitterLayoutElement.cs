        ...
        switch (m_AspectMode) {
            ...
            case AspectMode.HeightControlsWidth: {
                    ...
                    rectTransform.SetSizeWithCurrentAnchors(
                        ...
                        (((RectTransform)transform.parent).rect.height - VerticalPadding) * m_AspectRatio);
                    rectTransform.SetSizeWithCurrentAnchors(
                        RectTransform.Axis.Vertical,
                        ((RectTransform)transform.parent).rect.height - VerticalPadding);
                    break;
                }
            case AspectMode.WidthControlsHeight: {
                    ...
                    rectTransform.SetSizeWithCurrentAnchors(
                        RectTransform.Axis.Vertical,
                        (((RectTransform)transform.parent).rect.width - HorizontalPadding) / m_AspectRatio);
                    rectTransform.SetSizeWithCurrentAnchors(
                        RectTransform.Axis.Horizontal,
                        ((RectTransform)transform.parent).rect.width - HorizontalPadding);
                    break;
                }
