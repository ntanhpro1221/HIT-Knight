...
public class AimState_RangedWeapon : ConnectedState<RangedWeaponState, AimState_Weapon.HeadState, AimState_RangedWeapon.HeadState> {
...
#pragma warning disable CS0618 // Type or member is obsolete
    public AimState_RangedWeapon(RangedWeaponSM sm, AnimInfo animInfo, IRangedWeapon weapon) : base(
